...
class InitialBlock(nn.Module):
    ...
    def __init__(self,
        ...
        # Extension branch
        self.ext_branch = nn.MaxPool1d(2, stride=2)
...
class UpsamplingBottleneck(nn.Module):
    ...
    def __init__(self,
        ...
        # self.main_unpool1 = nn.MaxUnpool1d(kernel_size=2)
        self.main_unsample1 = nn.ConvTranspose1d(out_channels, out_channels, kernel_size=2, stride=2)
        ...
        self.ext_conv3 = nn.Sequential(
            ...
            nn.BatchNorm1d(out_channels), activation)
...
class LaneNet0508(nn.Module):
    def __init__(self, num_classes, divisor=1):
        ...
        self.initial_block = InitialBlock(1, 16 // divisor, padding=1)
        ...
        self.asymmetric2_3 = RegularBottleneck(64 // divisor, kernel_size=5, padding=2, asymmetric=False)
        ...
        self.asymmetric2_7 = RegularBottleneck(64 // divisor, kernel_size=5, asymmetric=False, padding=2)
        ...
        self.conv_out = nn.Sequential(
            nn.Conv1d(32 // divisor, 32 // divisor, kernel_size=3, padding=1, bias=False),
            nn.BatchNorm1d(32 // divisor),
            nn.ReLU(),
        )

        # deconv2
        self.deconv2 = nn.Sequential(
            nn.ConvTranspose1d(32 // divisor, 32 // divisor, kernel_size=2, stride=2, padding=0, bias=True),
            nn.BatchNorm1d(32 // divisor),
        ...
        self.deconv3 = nn.Sequential(
            nn.ConvTranspose1d(32 // divisor, num_classes, kernel_size=2, stride=2, padding=0, bias=True),
        )
