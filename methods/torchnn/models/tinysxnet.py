...
class tinysxnet1(nn.Module):
    def __init__(self, in_c=1, act_name='mish', bias=False, num_classes=1, dim=27):
        super(tinysxnet1, self).__init__()
...
class tinysxnet2(nn.Module):
    def __init__(self, in_c=1, act_name='mish', bias=False, num_classes=1, dim=27):
        super(tinysxnet2, self).__init__()
...
class tinysxnet3(nn.Module):
    def __init__(self, in_c=1, act_name='mish', bias=False, num_classes=1, dim=27):
        super(tinysxnet3, self).__init__()
...
class tinysxnet4(nn.Module):
    def __init__(self, in_c=1, act_name='mish', bias=False, num_classes=1, dim=27):
        super(tinysxnet4, self).__init__()

        self.convin = conv_norm_act(1, 1, k=3, pad=1, bias=bias, act_name=act_name)
...
if __name__ == '__main__':
    ...
    with torch.no_grad():
        ...
        num_classes = 1
        net = tinysxnet4(num_classes=num_classes).cuda()
        # print(net)
