...
class unettinywithmlp(nn.Module):
    ...
    def __init__(self, in_channels=1, out_channels=1, num_classes=1, dim=256):
        ...
        self.mlp = autoencoder(num_classes=num_classes, dim=dim)
...
if __name__ == '__main__':
    ...
    with torch.no_grad():
        ...
        num_classes = 1
        net = unettinywithmlp(num_classes=num_classes, dim=256).cuda()
