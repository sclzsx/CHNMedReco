...
get_metrics('DecisionTree', y_test, dt_pred_test)

gnb_clf = GaussianNB()
gnb_clf.fit(X_train, y_train)
gnb_pred_test = gnb_clf.predict(X_test)
get_metrics('GaussianNB', y_test, gnb_pred_test)

mnb_clf = MultinomialNB()
mnb_clf.fit(X_train, y_train)
mnb_pred_test = mnb_clf.predict(X_test)
get_metrics('MultinomialNB', y_test, mnb_pred_test)

bnb_clf = BernoulliNB()
bnb_clf.fit(X_train, y_train)
bnb_pred_test = bnb_clf.predict(X_test)
get_metrics('BernoulliNB', y_test, bnb_pred_test)

rf_clf = RandomForestClassifier()
rf_clf.fit(X_train, y_train)
rf_pred_test = rf_clf.predict(X_test)
get_metrics('RandomForest', y_test, rf_pred_test)

mlp_clf = MLPClassifier()
mlp_clf.fit(X_train, y_train)
mlp_pred_test = mlp_clf.predict(X_test)
get_metrics('MLP', y_test, mlp_pred_test)

lsvm_clf = svm.SVC(kernel='linear')
lsvm_clf.fit(X_train, y_train)
lsvm_pred_test = lsvm_clf.predict(X_test)
get_metrics('SVM', y_test, lsvm_pred_test)

gb_clf = GradientBoostingClassifier()
gb_clf.fit(X_train, y_train)
gb_pred_test = gb_clf.predict(X_test)
get_metrics('GradientBoosting', y_test, gb_pred_test)
